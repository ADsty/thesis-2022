...
class DeleteAdministrativeOffenceCaseDecisionUseCase(private val carAccidentDocumentsRepository: CarAccidentDocumentsRepository) {
    operator fun invoke(jwtToken: String, carAccidentInfoRequest: CarAccidentInfoRequest) =
        carAccidentDocumentsRepository.deleteAdministrativeOffenceCaseDecision(
            jwtToken,
