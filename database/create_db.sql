...
CREATE TABLE USERS(
    ...
    USER_ROLE INTEGER REFERENCES USER_ROLE (USER_ROLE_ID) NOT NULL,
    USER_STATE INTEGER REFERENCES USER_STATE (USER_STATE_ID) NOT NULL
);
...
CREATE TABLE DRIVER_LICENSE(
    ...
    DRIVER_LICENSE_DATE_OF_ISSUE DATE NOT NULL
);
...
CREATE TABLE VEHICLE_INSURANCE_POLICY(
    ...
    VEHICLE_INSURANCE_POLICY_EXPIRATION_DATE DATE NOT NULL
);
...
CREATE TABLE VEHICLE_PROFILE(
    ...
    VEHICLE_DRIVER INTEGER REFERENCES USERS (USER_ID) NOT NULL,
    VEHICLE_INSURANCE_POLICY INTEGER REFERENCES VEHICLE_INSURANCE_POLICY (VEHICLE_INSURANCE_POLICY_ID) NOT NULL
);
...
CREATE TABLE CAR_ACCIDENT(
    ...
    CAR_ACCIDENT_DATE DATE NOT NULL,
    CAR_ACCIDENT_TIME TIME NOT NULL,
...
CREATE TABLE CAR_ACCIDENT_ENTITY(
    ...
    CAR_ACCIDENT_ENTITY_STATE INTEGER REFERENCES CAR_ACCIDENT_ENTITY_STATE (CAR_ACCIDENT_ENTITY_STATE_ID) NOT NULL,
    CAR_ACCIDENT INTEGER REFERENCES CAR_ACCIDENT (CAR_ACCIDENT_ID) ON DELETE CASCADE NOT NULL,
    TRAFFIC_POLICE_OFFICER INTEGER REFERENCES USERS (USER_ID)
);


DROP TABLE IF EXISTS CHANGE_LABEL CASCADE;
CREATE TABLE CHANGE_LABEL(
    CHANGE_LABEL_ID SERIAL PRIMARY KEY,
...
CREATE TABLE CAR_ACCIDENT_ENTITY_CHANGELOG(
    ...
    CHANGE_LABEL INTEGER REFERENCES CHANGE_LABEL(CHANGE_LABEL_ID) NOT NULL
);
...
CREATE TABLE CAR_ACCIDENT_PARTICIPANT(
    ...
    PARTICIPANT_VEHICLE INTEGER REFERENCES VEHICLE_PROFILE(VEHICLE_PROFILE_ID) NOT NULL
);
...
CREATE TABLE MESSAGE(
    ...
    ADDRESSEE INTEGER REFERENCES USERS (USER_ID) NOT NULL,
    CHAT INTEGER REFERENCES CHAT (CHAT_ID) ON DELETE CASCADE NOT NULL,
    MESSAGE_CREATION_DATE DATE NOT NULL,
    MESSAGE_CREATION_TIME TIME NOT NULL,
    MESSAGE_UPDATE_DATE DATE,
...
CREATE TABLE ADMINISTRATIVE_OFFENCE_CASE_PROTOCOL(
    ...
    TIME_OF_FILL TIME NOT NULL,
    PLACE_OF_FILL TEXT NOT NULL,
    TRAFFIC_POLICE_OFFICER INTEGER REFERENCES USERS (USER_ID) NOT NULL,
    CAR_ACCIDENT_CULPRIT INTEGER REFERENCES USERS (USER_ID) NOT NULL,
    CULPRIT_ACTUAL_PLACE_OF_RESIDENCE TEXT NOT NULL,
    CAR_ACCIDENT_ENTITY INTEGER REFERENCES CAR_ACCIDENT_ENTITY (CAR_ACCIDENT_ENTITY_ID) NOT NULL,
...
CREATE TABLE ADMINISTRATIVE_OFFENCE_CASE_REFUSAL(
    ...
    PLACE_OF_FILL TEXT NOT NULL,
    TRAFFIC_POLICE_OFFICER INTEGER REFERENCES USERS (USER_ID) NOT NULL,
    CAR_ACCIDENT_INFO_SENDER INTEGER REFERENCES USERS (USER_ID) NOT NULL,
...
CREATE TABLE WITNESSES_ADDITIONAL_INFO(
    ...
    FIRST_WITNESS INTEGER REFERENCES CAR_ACCIDENT_WITNESS (CAR_ACCIDENT_WITNESS_ID) NOT NULL,
    SECOND_WITNESS INTEGER REFERENCES CAR_ACCIDENT_WITNESS (CAR_ACCIDENT_WITNESS_ID) NOT NULL
);
...
CREATE TABLE ADMINISTRATIVE_OFFENCE_SCENE_SCHEME(
    ...
    SCHEME_WITNESSES_INFO INTEGER REFERENCES WITNESSES_ADDITIONAL_INFO (WITNESSES_ADDITIONAL_INFO_ID) NOT NULL
);
...
CREATE TABLE ADMINISTRATIVE_OFFENCE_SCENE_INSPECTION(
    ...
    INSPECTION_WITNESSES_INFO INTEGER REFERENCES WITNESSES_ADDITIONAL_INFO (WITNESSES_ADDITIONAL_INFO_ID) NOT NULL,
...
CREATE TABLE CAR_ACCIDENT_ENTITY_DOCUMENTS(
    ...
    CAR_ACCIDENT_ENTITY INTEGER REFERENCES CAR_ACCIDENT_ENTITY (CAR_ACCIDENT_ENTITY_ID) ON DELETE CASCADE NOT NULL,
    ADMINISTRATIVE_OFFENCE_CASE_PROTOCOL INTEGER REFERENCES ADMINISTRATIVE_OFFENCE_CASE_PROTOCOL (ADMINISTRATIVE_OFFENCE_CASE_PROTOCOL_ID),
    ADMINISTRATIVE_OFFENCE_CASE_DECISION INTEGER REFERENCES ADMINISTRATIVE_OFFENCE_CASE_DECISION (ADMINISTRATIVE_OFFENCE_CASE_DECISION_ID),
    ADMINISTRATIVE_OFFENCE_CASE_INVESTIGATION INTEGER REFERENCES ADMINISTRATIVE_OFFENCE_CASE_INVESTIGATION (ADMINISTRATIVE_OFFENCE_CASE_INVESTIGATION_ID),
    ADMINISTRATIVE_OFFENCE_CASE_REFUSAL INTEGER REFERENCES ADMINISTRATIVE_OFFENCE_CASE_REFUSAL (ADMINISTRATIVE_OFFENCE_CASE_REFUSAL_ID),
    ADMINISTRATIVE_OFFENCE_SCENE_SCHEME INTEGER REFERENCES ADMINISTRATIVE_OFFENCE_SCENE_SCHEME (ADMINISTRATIVE_OFFENCE_SCENE_SCHEME_ID),
    ADMINISTRATIVE_OFFENCE_SCENE_INSPECTION INTEGER REFERENCES ADMINISTRATIVE_OFFENCE_SCENE_INSPECTION (ADMINISTRATIVE_OFFENCE_SCENE_INSPECTION_ID)
);
...
CREATE TABLE EXPLANATION_DOCUMENT(
    ...
    CAR_ACCIDENT_ENTITY_DOCUMENTS INTEGER REFERENCES CAR_ACCIDENT_ENTITY_DOCUMENTS (CAR_ACCIDENT_ENTITY_DOCUMENTS_ID) NOT NULL,
    DATE_OF_FILL DATE NOT NULL,
    TIME_OF_FILL TIME NOT NULL,
    PLACE_OF_FILL TEXT NOT NULL,
    TRAFFIC_POLICE_OFFICER INTEGER REFERENCES USERS (USER_ID) NOT NULL,
    CAR_ACCIDENT_PARTICIPANT INTEGER REFERENCES USERS (USER_ID),
    CAR_ACCIDENT_WITNESS INTEGER REFERENCES CAR_ACCIDENT_WITNESS (CAR_ACCIDENT_WITNESS_ID),
    INTERVIEWED_PERSON_TYPE INTEGER REFERENCES INTERVIEWED_PERSON_TYPE (INTERVIEWED_PERSON_TYPE_ID) NOT NULL
);
...
CREATE TABLE CONFISCATION_OF_DOCUMENTS_PROTOCOL(
    ...
    PLACE_OF_FILL TEXT NOT NULL,
    TRAFFIC_POLICE_OFFICER INTEGER REFERENCES USERS (USER_ID) NOT NULL,
    CAR_ACCIDENT_PARTICIPANT INTEGER REFERENCES USERS (USER_ID) NOT NULL,
    ...
    CONFISCATION_WITNESSES_INFO INTEGER REFERENCES WITNESSES_ADDITIONAL_INFO (WITNESSES_ADDITIONAL_INFO_ID) NOT NULL
);


DROP TABLE IF EXISTS USER_ACCIDENT_DOCUMENT CASCADE;
CREATE TABLE USER_ACCIDENT_DOCUMENT(
    USER_ACCIDENT_DOCUMENT_ID SERIAL PRIMARY KEY,
    CAR_ACCIDENT_ENTITY_DOCUMENTS INTEGER REFERENCES CAR_ACCIDENT_ENTITY_DOCUMENTS (CAR_ACCIDENT_ENTITY_DOCUMENTS_ID) NOT NULL,
    SEND_DATE DATE NOT NULL,
    SEND_TIME TIME NOT NULL,
    SENDER_PARTICIPANT INTEGER REFERENCES USERS (USER_ID) NOT NULL,
    EXPLANATION_TEXT TEXT NOT NULL
);


DROP TABLE IF EXISTS USER_DOCUMENT_FILES CASCADE;
CREATE TABLE USER_DOCUMENT_FILES(
    USER_DOCUMENT_FILES_ID SERIAL PRIMARY KEY,
    USER_ACCIDENT_DOCUMENT INTEGER REFERENCES USER_ACCIDENT_DOCUMENT (USER_ACCIDENT_DOCUMENT_ID) NOT NULL,
