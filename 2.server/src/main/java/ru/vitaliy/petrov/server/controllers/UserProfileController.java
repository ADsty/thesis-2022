...
import ru.vitaliy.petrov.server.dto.UserProfileDTO;
...
public class UserProfileController {
    ...
    public UserProfileDTO getUserProfile(@RequestHeader("Authorization") String jwtToken) {
        Long userID = jwtUtil.extractAllClaimsFromHeader(jwtToken).get("id", Long.class);
        return new UserProfileDTO(userProfileService.getUserProfile(userID));
    }
