...
CREATE TABLE USER_PROFILE(
    ...
    USER_DRIVER_LICENSE INTEGER REFERENCES DRIVER_LICENSE (DRIVER_LICENSE_ID) NOT NULL
);
...
CREATE TABLE ADMINISTRATIVE_OFFENCE_CASE_PROTOCOL(
    ...
    CULPRIT_ADDITIONAL_INFO INTEGER REFERENCES CULPRIT_ADDITIONAL_INFO (CULPRIT_ADDITIONAL_INFO_ID) NOT NULL,
...
CREATE TABLE CAR_ACCIDENT_ENTITY_DOCUMENTS(
    ...
    CAR_ACCIDENT_ENTITY INTEGER REFERENCES CAR_ACCIDENT_ENTITY (CAR_ACCIDENT_ENTITY_ID) NOT NULL,
    ADMINISTRATIVE_OFFENCE_CASE_PROTOCOL INTEGER REFERENCES ADMINISTRATIVE_OFFENCE_CASE_PROTOCOL (ADMINISTRATIVE_OFFENCE_CASE_PROTOCOL_ID) NOT NULL,
    ADMINISTRATIVE_OFFENCE_CASE_DECISION INTEGER REFERENCES ADMINISTRATIVE_OFFENCE_CASE_DECISION (ADMINISTRATIVE_OFFENCE_CASE_DECISION_ID) NOT NULL,
    ADMINISTRATIVE_OFFENCE_CASE_INVESTIGATION INTEGER REFERENCES ADMINISTRATIVE_OFFENCE_CASE_INVESTIGATION (ADMINISTRATIVE_OFFENCE_CASE_INVESTIGATION_ID) NOT NULL,
    ADMINISTRATIVE_OFFENCE_CASE_REFUSAL INTEGER REFERENCES ADMINISTRATIVE_OFFENCE_CASE_REFUSAL (ADMINISTRATIVE_OFFENCE_CASE_REFUSAL_ID) NOT NULL,
    ADMINISTRATIVE_OFFENCE_SCENE_SCHEME INTEGER REFERENCES ADMINISTRATIVE_OFFENCE_SCENE_SCHEME (ADMINISTRATIVE_OFFENCE_SCENE_SCHEME_ID) NOT NULL,
    ADMINISTRATIVE_OFFENCE_SCENE_INSPECTION INTEGER REFERENCES ADMINISTRATIVE_OFFENCE_SCENE_INSPECTION (ADMINISTRATIVE_OFFENCE_SCENE_INSPECTION_ID) NOT NULL
);
