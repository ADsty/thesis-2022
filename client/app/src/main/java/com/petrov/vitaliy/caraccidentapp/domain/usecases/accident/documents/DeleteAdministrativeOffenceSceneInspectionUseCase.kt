...
class DeleteAdministrativeOffenceSceneInspectionUseCase(private val carAccidentDocumentsRepository: CarAccidentDocumentsRepository) {
    operator fun invoke(jwtToken: String, carAccidentInfoRequest: CarAccidentInfoRequest) =
        carAccidentDocumentsRepository.deleteAdministrativeOffenceSceneInspection(
            jwtToken,
