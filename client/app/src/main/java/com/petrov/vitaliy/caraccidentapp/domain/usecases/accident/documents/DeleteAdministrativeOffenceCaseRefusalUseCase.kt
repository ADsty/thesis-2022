...
class DeleteAdministrativeOffenceCaseRefusalUseCase(private val carAccidentDocumentsRepository: CarAccidentDocumentsRepository) {
    operator fun invoke(jwtToken: String, carAccidentInfoRequest: CarAccidentInfoRequest) =
        carAccidentDocumentsRepository.deleteAdministrativeOffenceCaseRefusal(
            jwtToken,
